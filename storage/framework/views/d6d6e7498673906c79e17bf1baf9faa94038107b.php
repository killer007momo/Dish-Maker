...
unset($__errorArgs, $__bag); ?>
                         ...
                         <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="phone" type="text" class="form-control " name="phone" value="<?php echo e(old('phone')); ?>" required autocomplete="phone"  >
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/fr_rest_api/resources/views/auth/register.blade.php ENDPATH**/ ?>